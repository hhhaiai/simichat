...
- 首次动态 applicationId + `flutter test -d` 方案错误卸载正式包并导致 Pixel 8 应用私有数据丢失；LocalTransport / D2D 恢复均失败，已记录事故并禁止复用，详见 `docs/mobile-dreaming-reflection-recovery-smoke-2026-07-14.md`。
